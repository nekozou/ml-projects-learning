...
Ada1 = AdaBoostClassifier(tree.DecisionTreeClassifier(criterion='entropy'),n_estimators=100, algorithm="SAMME", learning_rate=0.2)

# 训练
Ada1.fit(x_train_pca, y_train)

Ada2 = AdaBoostClassifier(tree.DecisionTreeClassifier(criterion='entropy'),n_estimators=300, algorithm="SAMME", learning_rate=0.2)
